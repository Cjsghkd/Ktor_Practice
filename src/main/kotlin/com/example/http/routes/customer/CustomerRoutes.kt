...
import com.example.http.models.customer.Customer
...
fun Route.customerRouting() {
    route("/customer") {
        ...
        delete("{id?}") {
            ...
            if (customerStorage.removeIf{ it.id == id }) call.respondText("Customer removed correctly", status = HttpStatusCode.Accepted)
